...
export default function StressAssessment(): JSX.Element {
  ...
  const assessmentTypes: AssessmentType[] = [
    {
      ...
      questions: [
        { id: 0, text: "How often have you felt nervous or stressed?", category: "general" },
        { id: 1, text: "How often have you felt unable to control important things in your life?", category: "general" },
        { id: 2, text: "How often have you felt confident about handling personal problems?", category: "general", isReversed: true },
        { id: 3, text: "How often have you felt that things were going your way?", category: "general", isReversed: true },
        { id: 4, text: "How often have you found that you could not cope with all the things you had to do?", category: "general" },
        { id: 5, text: "How often have you been able to control irritations in your life?", category: "general", isReversed: true },
        { id: 6, text: "How often have you felt that you were on top of things?", category: "general", isReversed: true },
        { id: 7, text: "How often have you been angered because of things outside of your control?", category: "general" },
        { id: 8, text: "How often have you felt difficulties were piling up so high you could not overcome them?", category: "general" },
        { id: 9, text: "How often have you been upset because of something that happened unexpectedly?", category: "general" }
      ]
    },
    {
      id: "workplace",
      ...
      questions: [
        { id: 0, text: "How often do you feel overwhelmed by your workload?", category: "work" },
        { id: 1, text: "How often do you worry about work when you're not at work?", category: "work" },
        { id: 2, text: "How often do you feel satisfied with your work performance?", category: "work", isReversed: true },
        { id: 3, text: "How often do you feel supported by your colleagues or supervisor?", category: "work", isReversed: true },
        { id: 4, text: "How often do you feel pressured to meet unrealistic deadlines?", category: "work" },
        { id: 5, text: "How often do you feel your work-life balance is healthy?", category: "work", isReversed: true },
        { id: 6, text: "How often do you feel recognized for your contributions at work?", category: "work", isReversed: true },
        { id: 7, text: "How often do you feel stressed about job security?", category: "work" },
        { id: 8, text: "How often do you feel physically exhausted after work?", category: "work" },
        { id: 9, text: "How often do you look forward to going to work?", category: "work", isReversed: true }
      ]
    },
    {
      id: "relationship",
      ...
      questions: [
        { id: 0, text: "How often do you feel supported by your family and friends?", category: "personal", isReversed: true },
        { id: 1, text: "How often do you have conflicts with people close to you?", category: "personal" },
        { id: 2, text: "How often do you feel lonely or isolated?", category: "personal" },
        { id: 3, text: "How often do you feel satisfied with your relationships?", category: "personal", isReversed: true },
        { id: 4, text: "How often do you worry about disappointing others?", category: "personal" },
        { id: 5, text: "How often do you feel comfortable expressing your feelings?", category: "personal", isReversed: true },
        { id: 6, text: "How often do you feel judged by others?", category: "personal" },
        { id: 7, text: "How often do you feel like you have someone to talk to?", category: "personal", isReversed: true },
        { id: 8, text: "How often do you avoid social situations due to stress?", category: "personal" },
        { id: 9, text: "How often do you feel appreciated by the people in your life?", category: "personal", isReversed: true }
      ]
    },
    {
      id: "physical",
      ...
      questions: [
        { id: 0, text: "How often do you experience headaches or muscle tension?", category: "physical" },
        { id: 1, text: "How often do you have trouble sleeping due to stress?", category: "physical" },
        { id: 2, text: "How often do you feel energetic and well-rested?", category: "physical", isReversed: true },
        { id: 3, text: "How often do you experience digestive issues related to stress?", category: "physical" },
        { id: 4, text: "How often do you feel physically tense or restless?", category: "physical" },
        { id: 5, text: "How often do you engage in regular physical exercise?", category: "physical", isReversed: true },
        { id: 6, text: "How often do you eat well-balanced, nutritious meals?", category: "physical", isReversed: true },
        { id: 7, text: "How often do you use substances (caffeine, alcohol, etc.) to cope with stress?", category: "physical" },
        { id: 8, text: "How often do you feel physically healthy and strong?", category: "physical", isReversed: true },
        { id: 9, text: "How often do you experience rapid heartbeat or breathing when stressed?", category: "physical" }
      ]
    }
  ];
  ...
  const calculateStress = (): void => {
    if (Object.keys(responses).length < currentAssessment.questions.length) return;
    ...
    const stressData = getStressLevel(percentage, totalScore, maxScore);
    const recommendations = getStressRecommendations(percentage, activeAssessment);
  ...
  const getStressLevel = (percentage: number, score: number, maxScore: number) => {
    if (percentage <= 25) {
      return { 
        level: "Low Stress", 
        color: "#4CAF50", 
  ...
  const getStressRecommendations = (percentage: number, assessmentType: string): string[] => {
    ...
    if (specificRecommendations[assessmentType as keyof typeof specificRecommendations]) {
      recommendations = [
        ...recommendations,
        ...specificRecommendations[assessmentType as keyof typeof specificRecommendations]
      ];
    }
    ...
    <div className={homeStyle.container}>
      <main className={homeStyle.mainContent}>
        ...
        <div className={homeStyle.sectionWrapper}>
          ...
          {!result ? (
            <div className={homeStyle.sectionWrapper}>
              <h2 className={homeStyle.normalTitle}>{currentAssessment.name} Assessment</h2>
              ...
              <div className="text-center mb-4">
                <span className={homeStyle.normalText}>
                  Progress: {Object.keys(responses).length}/{currentAssessment.questions.length} questions
                </span>
              </div>
            ...
            <div className={homeStyle.sectionWrapper}>
              ...
              <div className={styles.resultCard}>
                ...
                <div className={styles.breakdown}>
                  ...
                  <div>
                    <div className={styles.statValue}>{currentAssessment.questions.length}</div>
                    <div className={styles.statLabel}>Questions</div>
                  </div>
                  <div>
                    <div className={styles.statValue}>{Math.round((result.totalScore / (currentAssessment.questions.length * 4)) * 100)}%</div>
